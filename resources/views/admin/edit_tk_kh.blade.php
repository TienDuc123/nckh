...
<body>
	...
	<!-- Large modal -->
	<div class="container">
		<form id="uploadForm_ud" enctype="multipart/form-data" action="{{route('updatetaikhoanmoi_kh')}}" method="POST">
			@csrf	
		    <div class="row">
				<input type="text" hidden name="id_nv" value="{{isset($user->kh_id)?$user->kh_id:''}}"> 
		      ...
		      <div class="col-6">
		      	...
		      	<input type="text" id="name_nv" name="name_nv" class="form-control" required value="{{isset($user->kh_ten)?$user->kh_ten:''}}">
		      </div>
		      <div class="col-6">
		      	<label for="ma_nv" class="btn-sm-2">Mã Khách Hàng</label>
		      	<input type="text" id="ma_nv" name="ma_nv" class="form-control" required value="{{isset($user->ma_kh)?$user->ma_kh:''	}}">
		      </div>
		      <div class="col-6">
		      ...
		      <div class="col-6">
		      	...
		      	<select name="gender" id="gender" class="form-control" required>
		      		<option hidden value="{{isset($user->kh_gender)?$user->kh_gender:''}}">{{isset($user->kh_gender)?$user->kh_gender:''}}</option>
		      ...
		      <div class="col-6">
		      	...
		      	<input type="text" name="address" id="address" class="form-control" required value="{{isset($user->kh_Address)?$user->kh_Address:''}}">
		      </div>
		      <div class="col-6">
